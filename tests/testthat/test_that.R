...
test_that("Azimuth back conversion", {
  ...
  expect_equal(PoR2Geo_azimuth(san_andreas, na_pa) %% 180, san_andreas$azi %% 180)
  expect_equal(PoR2Geo_azimuth(iceland, eu_na) %% 180, iceland$azi %% 180)
  expect_equal(PoR2Geo_azimuth(tibet, eu_in) %% 180, tibet$azi %% 180)
