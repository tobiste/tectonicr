...
This outlines how to propose a change to tectonicr. For more detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("tobiste/tectonicr", fork = TRUE)`.
...
Please note that the tectonicr project is released with a [Contributor
Code of
Conduct](https://tobiste.github.io/tectonicr/CODE_OF_CONDUCT.md). By
