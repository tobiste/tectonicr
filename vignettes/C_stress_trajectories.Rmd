...
plate [@DeMets1990]. In order to extract the plate motions between two other plates 
...
Alternatively, the PB2002 model by @Bird2003 is also provided as an ready-to 
...
euler.ld <- eulerpole_loxodromes(x = euler, angle = 45, n = 10, cw = TRUE)
