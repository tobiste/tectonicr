...
> The azimuth in the *PoR reference system*
$\alpha_{PoR}$ is the angular difference between the azimuth in geographic 
reference system $\alpha_{geo}$ and the (initial) bearing of the great circle 
...
a strike-slip regime and are orientated around 135° wrt to the Euler pole. Away 
from the plate boundary, the data becomes more noisy.

> This plot also allows to identify the nature of the plate boundary (i.e. 
inward, outward, or tangetial) in the first place.
...
We can see that that the data in fact scatters randomly at a distance of 6° 
from the plate boundary. Thus the plate boundary zone is somewhat 4--6° wide. 

> This plot allows to specify the width of the plate boundary zone.
