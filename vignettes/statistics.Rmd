...
For axial orientation data, summary statistics can also be expressed by the orientation tensor.
The orientation tensor is related to the moment of intertia given, that is minimised by calculating the Cartesian
...
by the sum of the eigenvalues. Then $1-\lambda_1$ is a
