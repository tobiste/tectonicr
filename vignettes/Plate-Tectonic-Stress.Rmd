...
\begin{equation} R =I_3 \cos\psi  + [\vec e]_x sin\psi  + (1 -\cos\psi) \vec e \otimes \vec e \end{equation}
...
[^ref2]: <div class="csl-entry">Wdowinski, S. (1998). A theory of intraplate tectonics. <i>Journal of Geophysical Research: Solid Earth</i>, <i>103</i>(3), 5037–5059. http://dx.doi.org/10.1029/97JB03390</div>
...
#   coord_quickmap() +
#   borders() +
#   geom_path(data=broom::tidy(euler.sm), aes(long, lat, group=group), color="blue", lty = 2, alpha = .5) + 
...
#   borders() +
#   geom_path(data=broom::tidy(euler.sm), aes(long, lat, group=group), color="blue", lty = 2, alpha = .5) + 
#   geom_path(data=broom::tidy(euler.gm), aes(long, lat, group=group), color="blue") + 
