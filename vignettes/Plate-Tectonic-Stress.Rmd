...
## Direction between two points on earth[^ref2]
[^ref2]: http://www.movable-type.co.uk/scripts/latlong.html
...
# Intra-plate tectonics (sensu Wdowinski, 1998)[^ref1]
...
## Quantitative comparison between predicted and observed SHmax[^ref1]
The normalized $\chi^2$ test quantitively compares the predicted (`plate_vector()`) and observed SHmax azimuth relative to the reported 1$\sigma$ standard deviation (Wdowinski 1999). 
