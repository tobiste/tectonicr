...
circular_dispersion(san_andreas.por$azi.PoR, mean = 135, w = 1 / san_andreas$unc)
```
...
circular_dispersion_MLE(san_andreas.por$azi.PoR, mean = 135, w = 1 / san_andreas$unc, R = 1000)
```
