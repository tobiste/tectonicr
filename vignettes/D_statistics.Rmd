...
rose_stats(san_andreas$azi, weights = 1 / san_andreas$unc) # show mean direction and 95% confidence interval
```

```{r rose2, echo=TRUE}
rose(san_andreas.por$azi, weights = 1 / san_andreas$unc, col = "grey", main = "PoR")
rose_stats(san_andreas.por$azi, weights = 1 / san_andreas$unc) # show mean direction and standard deviation
