...
An alternative is the newly introduced normalized Rayleigh Test for the goodness-of-fit of axial data:
```{r rayleigh2, echo=TRUE}
norm_rayleigh(san_andreas.por$azi.PoR, prd = 135, unc = san_andreas$unc)
```
