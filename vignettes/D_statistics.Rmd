...
Thus, for the calculation of mean, the average of 35 degrees and 355 degrees 
should be 15 degree instead of 195. 
...
algorithm is based on the MATLAB script 'stress2grid' by @Ziegler2017).
```{r interpolation}
