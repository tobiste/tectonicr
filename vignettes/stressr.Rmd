...
**stressr** is a free and open-source R package for modeling and analyzing the
...
**stressr** basically calculates the bearing from a point of 
...
In **stressr**, these directions can modeled by the following 
steps:
...
**stressr** also handles larger data sets. The 
...
In **stressr** this can be done with \code{equivalent_rotation}:
