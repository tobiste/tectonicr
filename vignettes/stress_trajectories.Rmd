...
```{r small_circles_around_ep, eval=TRUE, include=TRUE}
...
```{r great_circles_around_ep, eval=TRUE, include=TRUE}
...
```{r loxodromes, eval=TRUE, include=TRUE}
