...
map +
  ...
  geom_spoke(
    data = ifelse(
      inherits(san_andreas.res, "sf"), 
      sf::st_drop_geometry(san_andreas.res), 
      as.data.frame(san_andreas.res)),
    aes(
      x = lon,
      y = lat,
...
the plate boundary:
```{r san.andreas.distanceplot1, echo=TRUE}
...
```{r san.andreas.distanceplot1_roll, echo=TRUE}
...
```{r san.andreas.distanceplot2, echo=TRUE}
# Rolling norm chisq:
