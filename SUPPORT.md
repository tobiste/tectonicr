...
Thanks for using tectonicr! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/tobiste/tectonicr/issues/new).
...
requests](https://github.com/tobiste/tectonicr/issues) to make sure the
